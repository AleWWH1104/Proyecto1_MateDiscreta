...
cantidad = CombinatoriaAvanzada.calcular_cantidad(elementos, rep=False, orden=False, r=r)
...
cantidad = CombinatoriaAvanzada.calcular_cantidad(elementos, rep=True, orden=False, r=r)
...
cantidad = CombinatoriaAvanzada.calcular_cantidad(elementos, rep=False, orden=True, r=r)
print(f"Permutación sin repetición, importando el orden: {cantidad}")

# Ejemplo 4: Permutación con repetición, importando el orden
cantidad = CombinatoriaAvanzada.calcular_cantidad(elementos, rep=True, orden=True, r=r)
